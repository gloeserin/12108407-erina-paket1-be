...
export default function EditBukuPetugas() {
  ...
  const getBooksById = async () => {
    ...
    setName(response.data.response.judul);
    setPenerbit(response.data.response.penerbit);
    setDeskripsi(response.data.response.deskripsi);
    setPenulis(response.data.response.penulis);
    setTahun(response.data.response.tahun);
    setStock(response.data.response.stock);
    setNamaKategori(response.data.response.kategori_id);
  }
